...
const SecondaryLayouts = ({ children, title }) => {
  return (
    <div className="flex h-screen overflow-hidden">
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden mx-10 my-10">
        ...
        <div className="w-full flex justify-center">
          <div className="w-3/4 bg-gray-200 rounded-2xl p-10">{children}</div>
        </div>
      </div>
    </div>
  );
